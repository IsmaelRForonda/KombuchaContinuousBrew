...
ttk.Label(calculator, text="Welcome to GeeksForGeeks").grid(column=0, row=0, padx=30, pady=30)
ttk.Label(Constants, text="Lets gut going with some fermentation").grid(column=0, row=0, padx=30, pady=30)
